...
EMPTY_DATA="0x0000000000000000000000000000000000000000"
...
ZKSYNC_POOL_ADDRESS=$(forge create src/RebaseTokenPool.sol:RebaseTokenPool --rpc-url ${ZKSYNC_SEPOLIA_RPC_URL} --account updraft --legacy --broadcast --zksync --constructor-args ${ZKSYNC_REBASE_TOKEN_ADDRESS} ${EMPTY_DATA} ${ZKSYNC_RNM_PROXY_ADDRESS} ${ZKSYNC_ROUTER} | awk '/Deployed to:/ {print $3}')
